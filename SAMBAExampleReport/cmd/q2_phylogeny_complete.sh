qiime alignment mafft --i-sequences dbotu3_seqs.qza --o-alignment aligned_repseq.qza
qiime alignment mask --i-alignment aligned_repseq.qza --o-masked-alignment masked-aligned_repseq.qza
qiime phylogeny fasttree --i-alignment masked-aligned_repseq.qza --p-n-threads 6 --o-tree tree.qza >& tree.log 2>&1
